...
public class PTra08_05 {
	public static void main(String[] args) {
		...
		case 1:
			...
			System.out.println("四角形の面積は："+quadrangle(width, height));
			break;

		case 2:
			System.out.println("三角形の面積は："+triangle(width, height));
			break;

		default:
			System.out.println("1か2で答えて下さい。");
		}
	 ...
	 * ★ 以下の仕様でメソッドを作成してください
	 *
	 * 戻り値 ：double メソッド名 ：quadrangle 引数 ：double width, double height
	 *
	 ...
	 * ★ 以下の仕様でメソッドを作成してください
	 *
	 * 戻り値 ：double メソッド名 ：triangle 引数 ：double width, double height
	 *
	 * 引数で渡された横の長さ(width)と縦の長さ(height)から、三角形の面積を返すメソッド
	 */
	public static double triangle(double width, double heght) {

		return (width * heght / 2);
	}
